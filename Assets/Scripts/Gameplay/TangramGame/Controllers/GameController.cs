...
namespace Gameplay.TangramGame.Controllers
{
    ...
    public class GameController : MonoBehaviour
    {
        ...
        public Dictionary<Vector2Int, TileContent> CreateContents()
        {
            ...
            {
                contents.Add(content.key, new TileContent(content.pieces.ToHashSet(), new Color(132 / 255f,148 / 255f,188 / 255f)));
            }
        ...
        public void Start()
        {
            ...
            {
                Debug.Log($"Key: {pattern.Key}");
                foreach (var piece in pattern.Value.OffsetPieces)
                {
                ...
                var pos = oval * placementOffset / 2f * cellScale;
